...
from app.intents.handlers.add_allowlist_entries_handler import AddAllowlistEntriesHandler
...
from app.intents.handlers.get_allowlist_handler import GetAllowlistHandler
...
from app.intents.handlers.remove_allowlist_entry_handler import RemoveAllowlistEntryHandler
...
def _build_chat_handler() -> ChatHandler:
    ...
    handler_registry: dict[str, BaseIntentHandler] = {
        ...
        "GET_ALLOWLIST": GetAllowlistHandler(gateway),
        "HELP": HelpHandler(),
        ...
        "ADD_ALLOWLIST_ENTRIES": AddAllowlistEntriesHandler(base_url),
        "REMOVE_ALLOWLIST_ENTRY": RemoveAllowlistEntryHandler(gateway, base_url),
    }
